...
<html lang="en">
  ...
  <div class="container-fluid text-center">
	<div class="row">
		<div class="col-2 border border-5 border-danger">
		...
		<div class="col-2 border border-5 border-success ">
			<div class="row border border-2 border-white">
		...
		<div class="col-2 border border-5 border-warning">
			<div class="row border border-2 border-white">
		...
		<div class="col-2 border border-5 border-primary">
			<div class="row border border-2 border-white">
